...
function cal_popup3 (str_datetime) {
	...
	obj_calwindow = window.open( ((obj_calwindow.location)?'':'<?='media/calendar.html'?>')+'?id=' + this.id + '&s=' + this.dt_selected.valueOf() + '&c=' + this.dt_current.valueOf(),'Calendar', 'width=400,height=' + (this.time_comp ? 215 : 190) +',status=no,resizable=no,top=200,left=200,dependent=yes,alwaysRaised=yes');
