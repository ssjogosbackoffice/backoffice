...
TableTools.BUTTONS = {
    ...
    "serverPdf": $.extend( {}, TableTools.buttonBase, {
        //"sAction": "flash_pdf",
        "sNewLine": "\n",
        "sFileName": "*.pdf",
        "sButtonClass": "DTTT_button_pdf ",
        ...
        "sPdfMessage": "",
        "fnClick": function( nButton, oConfig, flash ) {
           oConfig.generatePdfFunction();
        }
    } ),

    "png": $.extend( {}, TableTools.buttonBase, {
        //"sAction": "flash_pdf",
        "sNewLine": "\n",
        "sFileName": "*.png",
        "sButtonClass": "DTTT_button_pdf ",
        "sButtonText": "PNG",
        "fnClick": function( nButton, oConfig, flash ) {
            html2canvas($("."+oConfig.classOfTable), {
 ...
 */
TableTools.DEFAULTS = {
	"sSwfPath":        "/media/dataTablesExtra/TableTools-2.2.0/swf/copy_csv_xls_pdf.swf",
	"sRowSelect":      "none",
	"sSelectedClass":  null,
	"fnPreRowSelect":  null,
	"fnRowSelected":   null,
	"fnRowDeselected": null,
	"aButtons":        [ "copy", "csv", "xls", "pdf", "print","serverPdf","png" ],
	"oTags": {
		"container": "div",
