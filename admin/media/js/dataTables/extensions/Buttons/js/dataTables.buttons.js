...
$.extend( Buttons.prototype, {
	 ...
	 * @param  {int|string} Button index
	 * @return {object} Button information - object contains `node` and `config`
	 *   properties
	 * @private
	 */
	...
	_resolveExtends: function ( conf )
	{
		...
		while ( conf && conf.extend ) {
			...
			// `config` object also assigned a class, but we want to concatenate
			...
			// Although we want the `config` object to overwrite almost all of
