...
if (function_exists('__autoload')) {
	trigger_error("logger: It looks like your code is using an __autoload() function. logger uses spl_autoload_register() which will bypass your __autoload() function and may break autoloading.", E_USER_WARNING);
}
