...
class LoggerConfigurationAdapterINI implements LoggerConfigurationAdapter {
	...
	*/
	 ...
	 * <pre>
	 * logger.logger.<name> = [<level>], [<appender-ref>, <appender-ref>, ...] 
	 * </pre>
	 * 
	 ...
	 * Appender class:
	 * <pre>
	 * logger.appender.<name> = <class>
	 * </pre>
	 * 
	 * Appender parameter:
	 * <pre>
	 * logger.appender.<name>.<param> = <value>
	 * </pre>
	 * 
 	 * Appender threshold:
	 * <pre>
	 * logger.appender.<name>.threshold = <level>
	 * </pre>
	 * 
 	 * Appender layout:
	 * <pre>
	 * logger.appender.<name>.layout = <layoutClass>
	 * </pre>
	 * 
	 * Layout parameter:
	 * <pre>
	 * logger.appender.<name>.layout.<param> = <value>
	 * </pre> 
	 * 
	 * For example, a full appender config might look like:
	 * <pre>
	 * logger.appender.myAppender = LoggerAppenderConsole
	 * logger.appender.myAppender.threshold = info
	 * logger.appender.myAppender.target = stdout
	 * logger.appender.myAppender.layout = LoggerLayoutPattern
	 * logger.appender.myAppender.layout.conversionPattern = "%d %c: %m%n"
	 * </pre>
	 * 
	...
	private function parseAppender($key, $value) {
		...
		trigger_error("logger: Don't know how to parse the following line: \"$key = $value\". Skipping.");
	}
	 ...
	 * <pre>
	 * logger.renderer.<renderedClass> = <renderingClass> 
	 * </pre>
	 * 
	 * @param string $key logger.renderer.<renderedClass>
