 ...
 * 
 * Configures logger based on a provided configuration file or array.
 * 
 * @package logger
...
class LoggerConfiguratorDefault implements LoggerConfigurator
{
	...
	/**
	 * Configures logger based on the given configuration. The input can 
	 ...
	 * parsed for whatever reason, a warning will be issued, and logger
	...
	private function warn($message) {
		trigger_error("logger: $message", E_USER_WARNING);
	}
}