...
/**
 * The output of the LoggerXmlLayout consists of a series of logger:event elements. 
 * 
 ...
 *   instead of logger namespace. This can be usefull when using log viewers 
 ...
 * 
 * <pre>
 * <logger:eventSet xmlns:logger="http://logging.apache.org/logger/" version="0.3" includesLocationInfo="true">
 * 	<logger:event logger="root" level="INFO" thread="13802" timestamp="1252456226491">
 * 		<logger:message><![CDATA[Hello World!]]></logger:message>
 * 		<logger:locationInfo class="main" file="examples/php/layout_xml.php" line="6" method="main" />
 * 	</logger:event>
 * </logger:eventSet>
 * </pre>
 *
...
class LoggerLayoutXml extends LoggerLayout {
	...
	const LOG4PHP_NS_PREFIX = 'logger';
	const LOG4PHP_NS = 'http://logging.apache.org/logger/';
	...
	/**
	 * If set to true, log4j namespace will be used instead of the logger 
	 * namespace.
	 * @var boolean 
	 */
	...
	/**
	 * Formats a {@link LoggerLoggingEvent} in conformance with the logger.dtd.
	 *
